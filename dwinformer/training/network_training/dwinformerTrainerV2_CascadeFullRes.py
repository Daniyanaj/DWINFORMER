...
import matplotlib
from dwinformer.configuration import default_num_threads
...
from dwinformer.training.network_training.dwinformerTrainerV2 import dwinformerTrainerV2
...
class dwinformerTrainerV2CascadeFullRes(dwinformerTrainerV2):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
                 unpack_data=True, deterministic=True, previous_trainer="dwinformerTrainerV2", fp16=False):
