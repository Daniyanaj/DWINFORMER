...
import matplotlib
from dwinformer.postprocessing.connected_components import determine_postprocessing
from dwinformer.training.data_augmentation.default_data_augmentation import get_default_augmentation
from dwinformer.training.dataloading.dataset_loading import DataLoader3D, unpack_dataset
from dwinformer.evaluation.evaluator import aggregate_scores
from dwinformer.training.network_training.dwinformerTrainer import dwinformerTrainer
from dwinformer.network_architecture.neural_network import SegmentationNetwork
from dwinformer.paths import network_training_output_dir
from dwinformer.inference.segmentation_export import save_segmentation_nifti_from_softmax
from batchgenerators.utilities.file_and_folder_operations import *
import numpy as np
from dwinformer.utilities.one_hot_encoding import to_one_hot
import shutil

matplotlib.use("agg")


class dwinformerTrainerCascadeFullRes(dwinformerTrainer):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
                 unpack_data=True, deterministic=True, previous_trainer="dwinformerTrainer", fp16=False):
        super(dwinformerTrainerCascadeFullRes, self).__init__(plans_file, fold, output_folder, dataset_directory,
    ...
    def do_split(self):
        super(dwinformerTrainerCascadeFullRes, self).do_split()
    ...
    def process_plans(self, plans):
        super(dwinformerTrainerCascadeFullRes, self).process_plans(plans)
    ...
    def validate(self, do_mirroring: bool = True, use_sliding_window: bool = True,
        ...
        if run_postprocessing_on_folds:
            # in the old dwinformer we would stop here. Now we add a postprocessing. This postprocessing can remove everything
