...
from dwinformer.training.dataloading.dataset_loading import load_dataset, DataLoader3D, DataLoader2D, unpack_dataset
from dwinformer.training.loss_functions.dice_loss import DC_and_CE_loss
from dwinformer.training.network_training.network_trainer_synapse import NetworkTrainer
...
class dwinformerTrainer_synapse(NetworkTrainer):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
        ...
        IMPORTANT: If you inherit from dwinformerTrainer and the init args change then you need to redefine self.init_args
        in your init accordingly. Otherwise checkpoints won't load properly!
        """
        super(dwinformerTrainer_synapse, self).__init__(deterministic, fp16)
    ...
    def run_training(self):
        ...
        super(dwinformerTrainer_synapse, self).run_training()
    ...
    def preprocess_patient(self, input_files):
        ...
        preprocessor_class = recursive_find_python_class([join(dwinformer.__path__[0], "preprocessing")],
                                                         preprocessor_name,
                                                         current_module="dwinformer.preprocessing")
        assert preprocessor_class is not None, "Could not find preprocessor %s in dwinformer.preprocessing" % \
                                               preprocessor_name
    ...
    def save_checkpoint(self, fname, save_optimizer=True):
        super(dwinformerTrainer_synapse, self).save_checkpoint(fname, save_optimizer)
        info = OrderedDict()
