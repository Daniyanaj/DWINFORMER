...
import argparse
from dwinformer.postprocessing.consolidate_postprocessing import consolidate_folds
...
def main():
    ...
    argparser.add_argument("-tr", type=str, required=False, default=None,
                           help="dwinformerTrainer class. Default: %s, unless 3d_cascade_fullres "
    ...
    if trainer is None:
        if model == "3d_cascade_fullres":
            trainer = "dwinformerTrainerV2CascadeFullRes"
        else:
            trainer = "dwinformerTrainerV2"
