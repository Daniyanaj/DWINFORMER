...
if __name__ == "__main__":
    ...
    plans = "dwinformerPlansv2.1"

    overwrite_plans = {
        'dwinformerTrainerCascadeFullRes': ['dwinformerPlans'],
    }

    trainers = [
        'dwinformerTrainerCascadeFullRes',
        'dwinformerTrainerV2CascadeFullRes_EducatedGuess',
        'dwinformerTrainerV2CascadeFullRes_EducatedGuess2',
        'dwinformerTrainerV2CascadeFullRes_EducatedGuess3',
        'dwinformerTrainerV2CascadeFullRes_lowerLR',
        'dwinformerTrainerV2CascadeFullRes',
        'dwinformerTrainerV2CascadeFullRes_noConnComp',
        'dwinformerTrainerV2CascadeFullRes_shorter_lowerLR',
        'dwinformerTrainerV2CascadeFullRes_shorter',
        'dwinformerTrainerV2CascadeFullRes_smallerBinStrel',
        #'',
        #'',
        #'',
        #'',
