...
if __name__ == "__main__":
    ...
    overwrite_plans = {
        'dwinformerTrainerV2_2': ["dwinformerPlans", "dwinformerPlans_customClip"], # r
        'dwinformerTrainerV2_2_noMirror': ["dwinformerPlans", "dwinformerPlans_customClip"],  # r
        'dwinformerTrainerV2_lessMomentum_noMirror': ["dwinformerPlans", "dwinformerPlans_customClip"],  # r
        'dwinformerTrainerV2_2_structSeg_noMirror': ["dwinformerPlans", "dwinformerPlans_customClip"],  # r
        'dwinformerTrainerV2_2_structSeg': ["dwinformerPlans", "dwinformerPlans_customClip"],  # r
        'dwinformerTrainerV2_lessMomentum_noMirror_structSeg': ["dwinformerPlans", "dwinformerPlans_customClip"],  # r
        'dwinformerTrainerV2_FabiansResUNet_structSet_NoMirror_leakyDecoder': ["dwinformerPlans", "dwinformerPlans_customClip"],  # r
        'dwinformerTrainerV2_FabiansResUNet_structSet_NoMirror': ["dwinformerPlans", "dwinformerPlans_customClip"],  # r
        'dwinformerTrainerV2_FabiansResUNet_structSet': ["dwinformerPlans", "dwinformerPlans_customClip"],  # r

    }

    trainers = ['dwinformerTrainer'] + [
        'dwinformerTrainerV2_2',
        'dwinformerTrainerV2_lessMomentum_noMirror',
        'dwinformerTrainerV2_2_noMirror',
        'dwinformerTrainerV2_2_structSeg_noMirror',
        'dwinformerTrainerV2_2_structSeg',
        'dwinformerTrainerV2_lessMomentum_noMirror_structSeg',
        'dwinformerTrainerV2_FabiansResUNet_structSet_NoMirror_leakyDecoder',
        'dwinformerTrainerV2_FabiansResUNet_structSet_NoMirror',
        'dwinformerTrainerV2_FabiansResUNet_structSet',
    ]
