    ...
    available_models = {
        ...
        "Task076_Fluo_N3DH_SIM": {
            'description': "Fluo-N3DH-SIM dataset of the cell tracking challenge. Segmentation target are N3DH cells and cell borders in fluorescence microscopy images.\n"
                           ...
                           "See https://github.com/MIC-DKFZ/dwinformer/blob/master/dwinformer/dataset_conversion/Task076_Fluo_N3DH_SIM.py",
        ...
        "Task082_BraTS2020": {
            ...
            'url': (
                "https://zenodo.org/record/4635763/files/Task082_dwinformerTrainerV2__dwinformerPlansv2.1_5fold.zip?download=1",
                "https://zenodo.org/record/4635763/files/Task082_dwinformerTrainerV2BraTSRegions_DA3_BN_BD__dwinformerPlansv2.1_bs5_5fold.zip?download=1",
                "https://zenodo.org/record/4635763/files/Task082_dwinformerTrainerV2BraTSRegions_DA4_BN__dwinformerPlansv2.1_bs5_15fold.zip?download=1",
                "https://zenodo.org/record/4635763/files/Task082_dwinformerTrainerV2BraTSRegions_DA4_BN_BD__dwinformerPlansv2.1_bs5_5fold.zip?download=1",
            )
        },
        "Task089_Fluo-N2DH-SIM_thickborder_time": {
            'description': "Fluo-N2DH-SIM dataset of the cell tracking challenge. Segmentation target are nuclei of N2DH cells and cell borders in fluorescence microscopy images.\n"
                           ...
                           "Note that the segmentation output of the models are cell center and cell border. These outputs mus tbe converted to an instance segmentation for the challenge. \n"
                           "See https://github.com/MIC-DKFZ/dwinformer/blob/master/dwinformer/dataset_conversion/Task089_Fluo-N2DH-SIM.py\n"
                           "Also see http://celltrackingchallenge.net/",
        ...
        "Task114_heart_MNMs": {
            'description':  "Cardiac MRI short axis images from the M&Ms challenge 2020.\n"
                            ...
                            "See https://github.com/MIC-DKFZ/dwinformer/blob/master/dwinformer/dataset_conversion/Task114_heart_mnms.py",
        ...
        "Task115_COVIDSegChallenge": {
            ...
            'url': (
                "https://zenodo.org/record/4635822/files/Task115_dwinformerTrainerV2_DA3__dwinformerPlans_v2.1__3d_fullres__10folds.zip?download=1",
                "https://zenodo.org/record/4635822/files/Task115_dwinformerTrainerV2_DA3_BN__dwinformerPlans_v2.1__3d_fullres__10folds.zip?download=1",
                "https://zenodo.org/record/4635822/files/Task115_dwinformerTrainerV2_ResencUNet__dwinformerPlans_FabiansResUNet_v2.1__3d_fullres__10folds.zip?download=1",
                "https://zenodo.org/record/4635822/files/Task115_dwinformerTrainerV2_ResencUNet_DA3__dwinformerPlans_FabiansResUNet_v2.1__3d_fullres__10folds.zip?download=1",
                "https://zenodo.org/record/4635822/files/Task115_dwinformerTrainerV2_ResencUNet_DA3_BN__dwinformerPlans_FabiansResUNet_v2.1__3d_lowres__10folds.zip?download=1",
            )
        },
...
def download_and_install_from_url(url):
    ...
    tempfile = join(home, '.dwinformerdownload_%s' % str(random_number))
...
def print_license_warning():
    ...
    print("Using the pretrained model weights is subject to the license of the dataset they were trained on. Some "
          ...
          "dwinformer_print_pretrained_model_info(task_name) to see a summary of the dataset and where to find its license!")
    print('######################################################')
    print('')
...
def download_by_name():
    ...
    parser.add_argument("task_name", type=str, help='Task name of the pretrained model. To see '
                                                                   'available task names, run dwinformer_print_available_'
                                                                   'pretrained_models')
...
def download_by_url():
    ...
    parser = argparse.ArgumentParser(
        description="Use this to download pretrained models. This script is intended to download models via url only. "
                    "If you want to download one of our pretrained models, please use dwinformer_download_pretrained_model. "
...
def print_pretrained_model_requirements():
    ...
    if taskname not in av.keys():
        raise RuntimeError("Invalid task name. This pretrained model does not exist. To see available task names, "
                           "run dwinformer_print_available_pretrained_models")
